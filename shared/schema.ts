...
export const configTable = pgTable("config_table", {
  ...
  sourceConnectionId: integer("source_connection_id").references(() => sourceConnectionTable.connectionId),
  ...
  targetConnectionId: integer("target_connection_id").references(() => sourceConnectionTable.connectionId),
