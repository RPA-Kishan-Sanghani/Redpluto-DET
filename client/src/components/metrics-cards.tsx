        ...
        return (
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500" data-testid={`text-${card.testId}-label`}>
                  {card.title}
                </p>
                <p className={`text-2xl font-semibold ${card.textColor}`} data-testid={`text-${card.testId}-value`}>
                  {card.value}
                </p>
              </div>
            </div>
